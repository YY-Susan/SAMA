...
def main():
    ...
    parser.add_argument('-nums', default=2)
    ...
    parser.add_argument('-log', default='../log/SAMA20days_1')
    parser.add_argument('-save_model', default='../saveModel/SAMA20days_softmax_2')
